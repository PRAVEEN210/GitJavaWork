 ...
 * package codecamp2;
 * 
 * import java.util.Scanner; public class Marks { public static void
 * main(String[] args) throws ArrayIndexOutOfBoundsException { Scanner sc=new
 * Scanner(System.in);
 * 
 * int[] physics=new int[6]; int[] chemistry=new int[6]; int[] maths=new int[6];
 * 
 * int[] physics1=new int[3]; int[] chemistry1=new int[3]; int[] maths1=new
 * int[3];
 * 
 * System.out.println("Marks for scholars in ECP-01");
 * System.out.println("Enter the marks for physics:"); for(int i=0;i<3;i++) {
 * physics[i]=sc.nextInt(); }
 * System.out.println("Enter the marks for Chemistry:"); for(int i=0;i<3;i++) {
 * chemistry[i]=sc.nextInt(); }
 * System.out.println("Enter the marks for Maths:"); for(int i=0;i<3;i++) {
 * maths[i]=sc.nextInt(); }
 * 
 * 
